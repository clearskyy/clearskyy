...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/ragequit/create-ragequit.php";
...
<title>create learn | clearskyy</title>
</head><body>
...
<div id="wrap-left" style="padding-bottom: 1%;">
	...
	<div class="content">
		<div class="type-ribbon">
			<h3>Write A #RAGEquit</h3>
		</div>
		
		<h2>logged in as: <?php echo $user; ?></h2>
		
		<form action="insert-ragequit.php" method="post" enctype="multipart/form-data">
			...
			<h2>write..</h2>
			<p>type up your #RAGEquit in here.</p>
