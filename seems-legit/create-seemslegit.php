...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/seems-legit/create-seemslegit.php";
...
<title>create seems legit | clearskyy</title>
</head><body>
...
<div id="wrap-left" style="padding-bottom: 1%;">
	...
	<div class="content">
		...
		<form action="insert-seemslegit.php" method="post" enctype="multipart/form-data">
			...
			<h2>write..</h2>
			<p>type up your Seems Legit in here.</p>
			<textarea name="content" rows="25" cols="20" placeholder="type up your review in here. " ></textarea> <br />
