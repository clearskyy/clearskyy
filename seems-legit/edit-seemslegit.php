...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/seems-legit/edit-seemslegit.php";
...
<div id="wrap-left">
	...
	<div class="content">
		<form action="update-seemslegit.php" method="post" enctype="multipart/form-data">
		
			<h2>seems legit embed </h2>
			
			<input type="text" name="embed" placeholder="place embed code here" value="<?php echo htmlspecialchars($embed); ?>" />
			
			<h2>Seems Legit image</h2>
			...
			<textarea name="review" rows="25" cols="20" placeholder="type up your review in here. (required)" ><?php echo htmlspecialchars($content); ?></textarea> 
			<br />
			<p>Edit your sidebar here</p>
			<textarea name="sidebar" rows="25" cols="20" ><?php echo htmlspecialchars($sidebar); ?></textarea> 
