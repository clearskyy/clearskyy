...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/admin/update/update-story.php";
	...
	//redirect to newly created story page
	header("location:$url");
