...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/editorial/update-editorial.php";
	...
	$updateTitle = $con -> prepare(
		"UPDATE `editorials` SET `title`= ? WHERE `id` = ?"
	);
