...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/admin/insert/insert-editorial.php";
	...
	$statement = $con->prepare( 
		"INSERT INTO editorials (title, content, url, date, author_id, imgSrc, imgAlt, imgTitle, sidebar, embed, c_id) VALUES (?, ?, ?,NOW(), ?, ?, ?, ?, ?, ?, ?)" 
	);
	$title = $_POST['title'];
	$imgSrc = $_POST['imgSrc'];
	$imgAlt = $_POST['imgAlt'];
	...
	$statement -> bind_param("sssisssssi",$title, $content, $url, $id, $imgSrc, $imgAlt, $imgTitle, $sidebar, $embed, $cid);
	$statement -> execute();
...
-->
	...
	//write it to a file
	file_put_contents("../../editorial/".$title.".php",$out);
