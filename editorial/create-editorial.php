...
if( isset( $_SESSION['user'] )){
	...
	$user = "";
	$_SESSION['referer'] = "http://clearskyy.net/editorial/create-editorial.php";
...
<title>create editorial | clearskyy</title>
</head><body>
...
<div id="wrap-left" style="padding-bottom: 1%;">
	...
	<div class="content">
		...
		<form action="insert-editorial.php" method="post" enctype="multipart/form-data">
			...
			<h2>write..</h2>
			<p>type up your editorial in here.</p>
