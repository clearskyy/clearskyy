<!--
   ...
   4. Fine tune the looks with CSS. Details: http://moot.it/docs/?clearskyy#styling

   For more help:

   http://moot.it/docs/?clearskyy
   http://moot.it/forum/
-->
<!doctype html>
...
<html>
   ...
   <body>
      ...
      <a class="moot" href="http://api.moot.it/clearskyy"></a>

      <!--
         (2) Example tag for commenting, put it on a different page
         <a class="moot" href="http://api.moot.it/clearskyy/blog#my-blog-entry"></a>

         (2) Example tag for threaded commenting
         <a class="moot" href="http://api.moot.it/clearskyy/blog/my-large-blog-entry"></a>

         Moot paths are awesome: http://moot.it/docs/?clearskyy#path
      -->
